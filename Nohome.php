...
<body>
  ...
  <div class="w3-main w3-padding-large" style="margin-left:40%">
    ...
    <!-- Header -->
    <img src="img/banner.jpg" style="margin:auto; display:block;">
    <header class="w3-container w3-center" style="padding:40px 16px" id="home">
      <h1 class="w3-jumbo"><b>RMUTT Counselling</b></h1>
      <h2 style="font-family:ASG Matrathan Light"><b>ระบบสนับสนุนการช่วยเหลือผู้ที่มีความเสี่ยงต่อภาวะซึมเศร้าทางอารมณ์ <b></h2>
      <img src="img/home.jpg" class="w3-image w3-hide-large w3-hide-small w3-round" style="display:block;width:60%;margin:auto;">
    ...
    <div class="w3-padding-32 w3-content" id="portfolio">
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half">
          <img url="img/RMUTT-logo-01.jpg" style="width:100%">
